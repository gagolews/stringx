...
|                                                            |                                                                                                                                                                                                                                                                                                                                                                                                                |
|------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `x`{#strsplit_:_x}                                         | character vector whose elements are to be examined                                                                                                                                                                                                                                                                                                                                                             |
| `pattern`{#strsplit_:_pattern}                             | character vector of nonempty search patterns                                                                                                                                                                                                                                                                                                                                                                   |
| `...`{#strsplit_:_...}                                     | further arguments to [`stri_split`](https://stringi.gagolewski.com/rapi/stri_split.html), e.g., `omit_empty`, `locale`, `dotall`                                                                                                                                                                                                                                                                               |
| `ignore_case`{#strsplit_:_ignore_case}                     | single logical value; indicates whether matching should be case-insensitive                                                                                                                                                                                                                                                                                                                                    |
| `fixed`{#strsplit_:_fixed}                                 | single logical value; `FALSE` for matching with regular expressions (see [about_search_regex](https://stringi.gagolewski.com/rapi/about_search_regex.html)); `TRUE` for fixed pattern matching ([about_search_fixed](https://stringi.gagolewski.com/rapi/about_search_fixed.html)); `NA` for the Unicode collation algorithm ([about_search_coll](https://stringi.gagolewski.com/rapi/about_search_coll.html)) |
| `perl`{#strsplit_:_perl}, `useBytes`{#strsplit_:_useBytes} | not used (with a warning if attempting to do so) \[DEPRECATED\]                                                                                                                                                                                                                                                                                                                                                |
| `ignore.case`{#strsplit_:_ignore.case}                     | alias to the `ignore_case` argument \[DEPRECATED\]                                                                                                                                                                                                                                                                                                                                                             |
| `split`{#strsplit_:_split}                                 | alias to the `pattern` argument \[DEPRECATED\]                                                                                                                                                                                                                                                                                                                                                                 |
