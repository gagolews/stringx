...
E(grepl2(x, "mario", ignore.case=TRUE), c(TRUE, TRUE, FALSE, FALSE, FALSE, FALSE, NA))
E(grepl2(x, "mario", fixed=NA, ignore.case=TRUE), c(TRUE, TRUE, FALSE, FALSE, FALSE, FALSE, NA))
...
E(`grepv2<-`(c("abc", "def", NA, ""), "a", value=c("X", "Y")), P(c("X", "def", NA, ""), warning="number of items to replace is not a multiple of replacement length"))
